 ...
 * 
 * <p>
 * 온톨로지에서 사용되는 객체(Object/Subject) 용어 사전입니다.
 * </p>
 * 
 * <h3>예시</h3>
 * 
 ...
 */
@Entity
@Table(name = "ontology_object_dict", uniqueConstraints = {
        @UniqueConstraint(name = "uk_object_workspace_category_en", columnNames = { "workspace_id", "category",
                "term_en" }),
        @UniqueConstraint(name = "uk_object_workspace_category_ko", columnNames = { "workspace_id", "category",
                "term_ko" })
}, indexes = {
